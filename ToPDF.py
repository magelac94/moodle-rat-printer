...
def convertir(listaPreguntas,destino,nombrePrueba,
...
#    descripcion = ""                                        # Descripcion - Opcional
    ...
    estiloFecha.add(ParagraphStyle(name='Right', 
        alignment=TA_RIGHT))
    lineaFecha = '<font size=9>%s</font>' % diaHora
    Prueba.append(Paragraph(lineaFecha, 
        estiloFecha["Normal"]))
    ...
    if (nombrePrueba == True):
        ...
        estiloTitulo.add(ParagraphStyle(name='Center', 
            alignment=TA_CENTER))
    ...
    if (idescripcion == True):
        ...
        estiloDescripcion.add(ParagraphStyle(name='Center', 
            alignment=TA_CENTER, fontName='Arial'))
        lineaDescripcion = '<font size=11>%s</font>' % descripcion
        Prueba.append(Paragraph(lineaDescripcion, 
            estiloDescripcion["Normal"]))  
        Prueba.append(Spacer(1, 12))


    # Preguntas y Respuestas
    estiloTituloPregunta=getSampleStyleSheet()
    estiloTituloPregunta.add(ParagraphStyle(name='Justify', 
        alignment=TA_JUSTIFY))

    estiloPregunta=getSampleStyleSheet()
    estiloPregunta.add(ParagraphStyle(name='Justify', 
        alignment=TA_JUSTIFY))

    estiloRespuesta=getSampleStyleSheet()
    estiloRespuesta.add(ParagraphStyle(name='Justify', 
        alignment=TA_JUSTIFY))

    estiloNumPregunta=getSampleStyleSheet()
    estiloNumPregunta.add(ParagraphStyle(name='Justify', 
        alignment=TA_JUSTIFY))
    ...
    for pregunta in listaPreguntas:
        if pregunta[4] != None:
            ...
            if (inumeroPregunta == True):
                ...
                Prueba.append(Paragraph(lineaNumeroPregunta, 
                    estiloNumPregunta["Normal"])) 

            #Titulo de la Pregunta - Opcional
            if (itituloPregunta == True):
                lineaTituloPregunta = '<font size=11>%s</font>' % pregunta[0]
                Prueba.append(Paragraph(lineaTituloPregunta, 
                    estiloTituloPregunta["Normal"])) 
                Prueba.append(Spacer(1, 6))

            #Texto de la Pregunta
            lineaPregunta = '<font size=12>%s</font>' % pregunta[1]
            Prueba.append(Paragraph(lineaPregunta, 
                estiloPregunta["Normal"])) 
            Prueba.append(Spacer(1, 12))
            ...
            if tipopregunta == "enssay":
                ...
                Prueba.append(Paragraph(line, 
                    estiloRespuesta["Normal"]))
                Prueba.append(Spacer(1, 12))
                ...
                for i in range(5,p):
                    ...
                    Prueba.append(Paragraph(lineaRespuesta, 
                        estiloRespuesta["Normal"]))
                    Prueba.append(Spacer(1, 6))
...
def imprimirRespuestas(listaRespuestas, destino):
    ...
    estiloLinea.add(ParagraphStyle(name='Justify',
